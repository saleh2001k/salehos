...
| **Arcade**   | 14 games with real cover art: DOOM, Prince of Persia, Crystal Caves, Lemmings 2 (via js-dos), Street Fighter II & Sonic the Hedgehog (via the Internet Archive emulator), plus Snake, Breakout, 2048, Minesweeper, Pong, Simon, Tic-Tac-Toe, Memory — homemade with sounds synthesized live in WebAudio (`lib/sfx.ts`) |
